...
<body>
	...
	$query = "INSERT INTO tb_testimoni(id_user, id_jalur, pekerjaan, isi, created, modified) VALUES ('$id_user', '$id_jalur', '$pekerjaan', '$isi', '$created', '$modified')";
	...
	if($exe) {
		echo "<script>
    		Swal.fire({
				...
				window.location.href='../detail-layanan?id=$id_jalur'
			});
		</script>";
	}else {
		echo "<script>
