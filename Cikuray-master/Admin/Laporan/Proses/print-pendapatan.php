...
$pdf->Cell(34 ,5,'Jarwo',0,1);//end of line
...
$no = 1;
$query = "SELECT t.id_transaksi, t.jumlah_pesan, t.status, t.total_harga, u.nama_lengkap, w.nama_jalur FROM tb_transaksi t INNER JOIN tb_user u ON t.id_user = u.id_user INNER JOIN tb_jalur w ON t.id_jalur = w.id_jalur ORDER BY t.id_transaksi ASC";
...
while($row = mysqli_fetch_array($exe)) {
	...
	$pdf->Cell(10 ,5,''.$no++.'',1,0, 'C');
	$pdf->Cell(50 ,5,''.$row['nama_jalur'].'',1,0, 'C');
