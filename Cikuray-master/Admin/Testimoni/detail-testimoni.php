...
$query = "SELECT t.id_testimoni, t.isi, t.pekerjaan, u.nama_lengkap, w.nama_jalur FROM tb_testimoni t INNER JOIn tb_user u ON t.id_user = u.id_user INNER JOIN tb_jalur w ON t.id_jalur = w.id_jalur WHERE t.id_testimoni = '$id_testimoni'";
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                       ...
                       <input type="text" name="wisata" id="wisata" class="form-control" readonly="" value="<?php echo $row['nama_jalur'];?>" style="background-color: #FFFFFF;">   
                     </div>                   
                   </div> 
                 </div>
                 <div class="row">
