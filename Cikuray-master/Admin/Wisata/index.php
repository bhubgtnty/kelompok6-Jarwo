        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title"><a href="tambah-jalur" class="btn btn-primary">Tambah</a></h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php
                  $no = 1;
                  $query = "SELECT * FROM tb_jalur ORDER BY id_jalur ASC";
                  $exe = mysqli_query($conn, $query);
                  ...
                  <tr>
                    ...
                    <td><a href="detail-wisata?id=<?php echo $row['id_jalur'];?>" class="btn btn-secondary">Detail</a></td>
                  </tr>
                <?php } ?>
                </tbody>
              </table>
