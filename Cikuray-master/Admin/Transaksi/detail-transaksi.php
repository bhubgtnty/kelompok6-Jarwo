...
$query = "SELECT t.id_transaksi, t.kode, t.jumlah_pesan, t.status, t.total_harga, t.bukti, u.nama_lengkap, w.nama_jalur 
          FROM tb_transaksi t 
          INNER JOIN tb_user u ON t.id_user = u.id_user 
          INNER JOIN tb_jalur w ON t.id_jalur = w.id_jalur 
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="kode" id="kode" class="form-control" value="<?php echo $row['kode'];?>" readonly="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <?php
                                                        // Ambil nama file bukti dari hasil query
                                                        $bukti = $row['bukti'];
                                                        if (!empty($bukti)) {
                                                            // Tampilkan gambar bukti pembayaran
                                                            echo '<img src="../../assets/images/bukti/' . $bukti . '" class="img-fluid" style="max-width: 300px;">';
                                                        } else {
                                                            echo 'Tidak ada bukti pembayaran yang diunggah.';
                                                        }
                                                        ?>
                                                    </div>
                                                </div>
